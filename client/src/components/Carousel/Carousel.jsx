...
const slidesCarousel = [
    ...
    {   
        img: 'https://res.cloudinary.com/dviri5ov1/image/upload/c_fill,h_280,w_1500/v1679507442/fastball/system/img2_g0rwfp.webp', 
        coment: 
            <div className='absolute top-4 w-full flex justify-center items-center'>
    ...
    {   
        img: 'https://res.cloudinary.com/dviri5ov1/image/upload/c_fill,h_280,w_1500/v1679507442/fastball/system/img3_fylx1i.webp', 
        coment:
            <div className='absolute top-4 w-full flex justify-center items-center'>
    ...
    {   
        img: 'https://res.cloudinary.com/dviri5ov1/image/upload/c_fill,h_280,w_1500/v1679507442/fastball/system/img4_oseduk.webp', 
        coment:
            <div className='absolute top-4 w-full flex justify-center items-center'>
    ...
    {   
        img: 'https://res.cloudinary.com/dviri5ov1/image/upload/c_fill,h_280,w_1500/v1679507441/fastball/system/img5_shdi0o.webp', 
        coment: 
            <div className='absolute top-4 w-full flex justify-center items-center'>

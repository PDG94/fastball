...
const CategoryButtons = () => {
    ...
    return (
        <div className="flex flex-row justify-between gap-x-5 px-12 pb-10" >
          <div onClick={pruebaClick} className="max-w-sm bg-gray-100 overflow-hidden drop-shadow-lg rounded-lg">
            <Link>
          ...
          <div  onClick={pruebaClick} className="max-w-sm bg-gray-100 overflow-hidden shadow-lg rounded-lg">
            <Link>

...
export default function Paginado({productsPerPage, allProducts, pagination}){
    ...
    const styleButtonNav = (number)=> {
        return currentPage === number
                ? 'rounded-md drop-shadow-lg text-white bg-blue-600 py-1.5 px-3 text-xl my-0 mx-2.5 inline cursor-pointer'
                : 'rounded-md drop-shadow-lg text-white bg-blue-400 hover:bg-blue-400 py-1.5 px-3 text-xl my-0 mx-2.5 inline cursor-pointer'
    }
    return(
